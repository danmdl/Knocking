const botonbrand46 = document.getElementById("brand46");
botonbrand46.addEventListener("click", popupOptions);
...
var btn0 = document.createElement("button");
   ...
   btn0.addEventListener("click", function(){
       ...
       window.open("./Recursos externos/presentation/Opu Probiotics.pdf", "_blank", "noopener");
   });

   var btn1 = document.createElement("button");
   btn1.innerText = "Benefits";
   btn1.addEventListener("click", function(){
       //add here the action that you want
       window.open("https://www.healthline.com/nutrition/8-health-benefits-of-probiotics", "_blank", "noopener");
   });

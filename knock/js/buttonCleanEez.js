const botonbrand48 = document.getElementById("brand48");
botonbrand48.addEventListener("click", popupOptions);
...
function popupOptions(){
   ...
   btn1.innerText = "SDS Ingredients List";
   btn1.addEventListener("click", function(){
       //add here the action that you want
       window.open("./Recursos externos/Others/SDSList.pdf", "_blank", "noopener");
   });

   var btn2 = document.createElement("button");
   btn2.innerText = "How To Videos";
   btn2.addEventListener("click", function(){
       //add here the action that you want
       window.open("https://clean-eez.com/pages/how-to-videos-1", "_blank", "noopener");
   });

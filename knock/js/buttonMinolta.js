...
function popupOptions(){
    ...
    btn1.innerText = "Comparison";
    btn1.addEventListener("click", function(){
        //add here the action that you want
        window.open("./Recursos externos/Others/minoltaComparison.png", "_blank", "noopener");
    });

    
    var btn2 = document.createElement("button");
    btn2.innerText = "MNCD370 Specs";
    btn2.addEventListener("click", function(){
        //add here the action that you want
        window.open("./Recursos externos/Others/MNCD370Specs.png", "_blank", "noopener");
    });

    var btn3 = document.createElement("button");
    btn3.innerText = "MNCD450 Specs";
    btn3.addEventListener("click", function(){
        //add here the action that you want
        window.open("./Recursos externos/Others/MNCD450Specs.png", "_blank", "noopener");
    });

    var btn4 = document.createElement("button");
    btn4.innerText = "MNCD370 Manual";
    btn4.addEventListener("click", function(){
        //add here the action that you want
        window.open("./Recursos externos/manuals/MNCD370Manual.pdf", "_blank", "noopener");
    });

    var btn5 = document.createElement("button");
    btn5.innerText = "MNCD450 Manual";
    btn5.addEventListener("click", function(){
        //add here the action that you want
        window.open("./Recursos externos/manuals/MNCD450Manual.pdf", "_blank", "noopener");
    });

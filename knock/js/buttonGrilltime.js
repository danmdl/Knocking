const botonOpciones12 = document.getElementById("brand12");
botonOpciones12.addEventListener("click", popupOptions);
...
function popupOptions(){
    ...
    btn1.addEventListener("click", function(){
        ...
        window.open("https://www.live2grill.com/pages/faq", "_blank", "noopener");
    });
    var btn2 = document.createElement("button");
    btn2.innerText = "How to -video";
    btn2.addEventListener("click", function(){
        //add here the action that you want
        window.open("hhttps://www.youtube.com/watch?v=Z9Y0itGrqHw", "_blank", "noopener");
    });

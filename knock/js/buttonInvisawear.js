const botonOpciones14 = document.getElementById("brand14");
botonOpciones14.addEventListener("click", popupOptions);
...
function popupOptions(){
    ...
    btn1.addEventListener("click", function(){
        ...
        window.open("https://www.invisawear.com/pages/faqs", "_blank", "noopener");
    });
    var btn2 = document.createElement("button");
    btn2.innerText = "App setup -video";
    btn2.addEventListener("click", function(){
        //add here the action that you want
        window.open("https://www.youtube.com/watch?v=MH_RN4wK6mA", "_blank", "noopener");
    });
    var btn3 = document.createElement("button");
    btn3.innerText = "Empty";
    btn3.addEventListener("click", function(){
        //add here the action that you want
        alert("Nothing else to watch")
    });

const botonbrand31 = document.getElementById("brand31");
botonbrand31.addEventListener("click", popupOptions);
...
function popupOptions(){
 ...
 btn1.addEventListener("click", function(){
     ...
     window.open("./Recursos externos/presentation/DropStop.pdf", "_blank", "noopener");
 ...
 btn2.addEventListener("click", function(){
     //action
     window.open("https://www.buydropstop.com/info/faq", "_blank", "noopener");
 });

const botonOpciones5 = document.getElementById("brand5");
botonOpciones5.addEventListener("click", popupOptions);
...
function popupOptions(){
    ...
    btn1.addEventListener("click", function(){
        ...
        window.open("https://manuals.plus/wp-content/uploads/2020/11/Key-Smart-Tike-Tracker-User-Manual.pdf", "_blank", "noopener");
    });
    var btn2 = document.createElement("button");
    btn2.innerText = "Tutorials";
    btn2.addEventListener("click", function(){
        //add here the action that you want
        window.open("https://www.youtube.com/watch?v=MoowSmBgS_0", "_blank", "noopener");
    });

const botonbrand35 = document.getElementById("brand35");
botonbrand35.addEventListener("click", popupOptions);
...
function popupOptions(){
   ...
   btn1.addEventListener("click", function(){
       //action
       window.open("./Recursos externos/presentation/HeyBuddy.pdf", "_blank", "noopener");
   });
   var btn2 = document.createElement("button");
   btn2.innerText = "Faqs";
   btn2.addEventListener("click", function(){
       //action
       window.open("https://heybuddyheypal.com/pages/tips-tricks", "_blank", "noopener");
   });
   ...
   btn3.addEventListener("click", function(){
     //action
     window.open("https://www.youtube.com/@heybuddyheypal1026/videos", "_blank", "noopener", "_blank", "noopener");     
   });

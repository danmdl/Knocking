const botonbrand50 = document.getElementById("brand50");
botonbrand50.addEventListener("click", popupOptions);
...
function popupOptions(){
   ...
   btn0.addEventListener("click", function(){
       ...
       window.open("https://hydroslife.com/pages/questions", "_blank", "noopener");
   });
   var btn1 = document.createElement("button");
   btn1.innerText = "Replacement Filter";
   btn1.addEventListener("click", function(){
       //add here the action that you want
       window.open("https://hydroslife.com/collections/filters-accessories", "_blank", "noopener");
   });
